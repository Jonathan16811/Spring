...
public class NewReplyMailFactory {
	...
	public String generateNewReplyMailContent(Answer answer) {
		...
		thymeleafContext.setVariable("topicOwnerName", answerTopic.getOwnerName());
		thymeleafContext.setVariable("topicShortDescription", answerTopic.getShortDescription());
	...
	private Object getFormattedCreationTime(Answer answer) {
